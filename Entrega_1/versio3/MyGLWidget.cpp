...
//  glViewport (0, 0, ample, alt);
  ...
  modelTransformArbre(posicioArbre[0],midaArbre[0]);
  // Pintem tronc
...
void MyGLWidget::modelTransformArbre (const glm::vec3& posicio, float mida)
{
  ...
  TG = glm::translate(TG,glm::vec3(0.,0.8,0.));
  TG = glm::scale(TG,glm::vec3(0.625,0.625,0.)); //per tal de que l'alcada sigui 1
